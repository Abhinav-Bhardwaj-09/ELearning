...
public class EmployeeController {
	...
	public void searchByIdLandingPage(){
	}
	@RequestMapping(value="/searchhEmp")
	public String searchById(@RequestParam("eid") int eid, Model m){
		Employee targetEmp = dao.getEmpId(eid);
		m.addAttribute("emp", targetEmp);
		System.out.println();
		System.out.println("searcheduser: " + targetEmp.getEid() + " " + targetEmp.getName()  + " " + targetEmp.getSalary());
		System.out.println();
		return "searchedEmp";
	}
	@RequestMapping(value="/searchedEmp")

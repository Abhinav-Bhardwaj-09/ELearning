...
public class ProductRetrieveServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			String querry = "Select * from Product where pId = ?";
			...
			out.println("<tr>");
			out.println("<td>" + result.getInt("pId") + "</td>");
			out.println("<td>" + result.getString("pName") + "</td>");
			out.println("<td>" + result.getLong("pPrice") + "</td>");	
			out.println("<td>" + result.getInt("pQty") + "</td>");	
			out.println("</tr>");
			out.println("</table>");
			}
			else {
